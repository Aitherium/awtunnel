"""Stack-aware `doctor` for awtunnel.
...
interesting failures live BETWEEN them. "awtunnel is installed" is not the useful
fact -- "awtunnel is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awtunnel needs at runtime, and a
